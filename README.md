...
* **Failure Classification:** Automatic grouping of events by levels: *Failure* (red), *Warning* (yellow), *Advisory* (blue).
* **Anomaly Detection:**
...
*This project was developed as part of the "Computerized Information Management Systems" university discipline.*