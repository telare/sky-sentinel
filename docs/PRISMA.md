...
_Example: One UAVdata packet can have many FailureLogs._
...
_Example: One UAV has one specific HardwareConfig. Requires `@unique` on the foreign key._
...
_Example: Many Pilots can fly many different UAVs._
